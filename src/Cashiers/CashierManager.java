...
public class CashierManager {
    ...
    private Cashier current_cashier = null;
    ...
    public void get_cashier(int cashier_id){
        this.current_cashier = cashiers.get(cashier_id);
        double total = 0;
        System.out.println("##########################");
        System.out.println("#          VENTA         #");
        System.out.println("##########################");
        System.out.println("Cliente: " + this.current_cashier.get_client_name());
        System.out.println("Cedula de identidad: " + this.current_cashier.get_client_ci());
        System.out.println("__________________________");
        System.out.println("  PRODUCTOS EN LA VENTA   ");
        System.out.println("__________________________");
        if (this.current_cashier.product_ids.size() > 0) {
            int index_product = 0;
            for(int product_id : this.current_cashier.product_ids){
                StringBuilder product = this.inventory.getProduct(product_id);
                double product_price = this.inventory.getPrice(product_id);
                double amount_product = this.current_cashier.amount_products.get(index_product);
        ...
        this.current_cashier.set_total(total);
        System.out.println("__________________________");
        System.out.println("Total productos: " + this.current_cashier.product_ids.size());
